...
- [x] **集成测试** (截止日期: 12 月 9 日)
  - [x] API 测试 (完成于 11 月 27 日)
  - [x] E2E 测试 (截止日期: 12 月 9 日)
    ...
    - [x] 登录/注册页测试 (完成于 11 月 28 日)
      ...
      - 表单填写验证
      - 密码重置流程验证
    - [x] 仪表板页面测试 (完成于 12 月 20 日)
      - 健康数据概览卡片展示
      - 体重/卡路里图表渲染
      - 快速记录功能入口
      - 导航跳转功能
    - [x] 身体数据页面测试 (完成于 12 月 20 日)
      - 身体指标列表展示
      - 新增身体指标记录
      - 编辑/删除记录
      - 历史趋势图表交互
    - [x] 饮食管理页面测试 (完成于 12 月 20 日)
      - 饮食记录列表展示
      - 新增饮食记录（餐点类型、卡路里）
      - 编辑/删除饮食记录
      - 日期筛选功能
    - [x] 运动管理页面测试 (完成于 12 月 20 日)
      - 运动记录列表展示
      - 新增运动记录（类型、时长、消耗）
      - 编辑/删除运动记录
    - [x] 睡眠数据页面测试 (完成于 12 月 20 日)
      - 睡眠记录列表展示
      - 新增睡眠记录（时长、质量）
      - 编辑/删除睡眠记录
    - [x] AI 助手页面测试 (完成于 12 月 20 日)
      - 消息发送与流式响应展示
      - 历史记录加载与持久化
      - 快捷建议点击交互
      - 连接状态与错误处理
    - [x] 个人资料页面测试 (完成于 12 月 20 日)
      - 个人信息展示与编辑（头像、昵称、性别）
      - 健康目标设置（体重、热量、睡眠目标）
      - 修改密码功能验证
      - 退出登录流程
    - [x] 全局布局与导航测试 (完成于 12 月 20 日)
      - 侧边栏导航跳转正确性
    - [x] 通用功能与边界测试 (完成于 12 月 20 日)
      - 数据导出功能验证 (CSV 格式与内容)
      - 列表空状态展示 (Empty State)
      - 网络错误与异常处理提示
      - 表单非法输入验证反馈
...
- 完善前端集成测试覆盖（Body-Data, Diet, Profile, Dashboard, Chat, Exercise, Sleep）
